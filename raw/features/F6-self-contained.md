...
- **AC6.1** — Установка — только Unity-пакет (UPM или `Assets/`). По умолчанию
  ноль файлов в папке LLM-клиента (скиллы/плагины/команды); опциональная
  recovery-крошка — только с явного согласия (F7/AC7.4).
